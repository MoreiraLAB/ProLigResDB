...
from ProLigRes_variables import HEADER_COLUMNS, ONE_TO_THRE_CODE_CONVERTER, \
                                ...
                                SECTIONS_FEATURES_SPLITS, PROCESSED_TERMINATION, FEATURES_TERMINATION, SPOTONE_FOLDER
import pandas as pd
import string
import sys
import os
...
generate_simple_features(processed_chains, output_file_name, original_chains_names, test_file)
