# 6-pssm_features.py
# INPUT FILES: (path: "./DATA_ANALYSIS/") "proteins.fasta" - FASTA file with interacting protein chains
...
from ProLigRes_variables import PSSM_FOLDER, H5_FOLDER, write_txt

from ViralBindPredict_variables import FEATURES_FOLDER, SPOTONE_FOLDER, PSSM_FOLDER, BLAST_FOLDER, H5_FOLDER, write_txt, h5_keys, pssm_variables
import os
import subprocess
